...
//  FIXME : 후보등록시 BJ의 지갑 정보는 가져오는건지 안가져오는건지????
...
exports.newbjProcessing = function (req, res) {
    ...
    validator.check().then(function (matched) {
        ...
        // console.log(req.user.uid, safe_bj_name, safe_bj_contents, safe_bj_active_area,safe_bjEmail, safe_reason_safe, req.body.photokey1, safe_photokey2, safe_photokey3, safe_photokey4, safe_photo1_src, safe_photo2_src, safe_photo3_src, safe_photo4_src, safe_channel1, safe_channel2, safe_channel3, safe_fanclub, safe_video1, safe_video2, safe_recommender, safe_userEmail, safe_userMPhone, safe_userPhone);
        ...
        dbpool.getConnection(function(err, conn) {
            ...
            var query = conn.query('INSERT INTO bjc_bjs (user_pk, bj_name, bj_contents, bj_active_area, bj_email, bj_introduce, bj_photo1, bj_photo2, bj_photo3, bj_photo4, bj_photo1_src, bj_photo2_src, bj_photo3_src, bj_photo4_src, bj_channel1, bj_channel2, bj_channel3, bj_fanclub, bj_hot_video_src1, bj_hot_video_src2, self_yn) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1)',
                [req.user.uid, safe_bj_name, safe_bj_contents, safe_bj_active_area,safe_bjEmail, safe_reason_safe, req.body.photokey1, safe_photokey2, safe_photokey3, safe_photokey4, safe_photo1_src, safe_photo2_src, safe_photo3_src, safe_photo4_src, safe_channel1, safe_channel2, safe_channel3, safe_fanclub, safe_video1, safe_video2],

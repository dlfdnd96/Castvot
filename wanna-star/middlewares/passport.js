...
function insertPassport(accessToken, refreshToken, profile, done) {
    ...
    if(profile !== undefined ) {
        ...
        dbpool.getConnection(function(err, conn) {
            ...
            conn.query('INSERT INTO bjc_passport_user (user_name, user_sns, user_identify_id) VALUES(?, ?, ?) ON DUPLICATE KEY UPDATE mdate=NOW()', [profile.displayName, profile.provider, profile.id], function(err, result, fields) {
                if(err) {

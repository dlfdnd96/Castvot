...
<head>
	...
	<style type="text/css">
		...
		.navbar-brand>img { width: 130px; margin-left: 49px; }
	...
	<div id="wrapper">
		<nav class="navbar navbar-default top-navbar" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">
					<!--  --><img src="resources/images/castvot_logo.png">
				</a>
		...
		<div id="page-wrapper">
			...
			<div id="page-inner">
				...
				<footer>
					<p>
						All right reserved. Template by: <a href="http://webthemez.com">WebThemez.com</a>
					</p>
				</footer>
			</div>
			<!-- /. PAGE INNER  -->
